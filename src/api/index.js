...
const API_BASE_URL = import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace(/\/$/, '') : "http://localhost:5000";
...
export const messagesAPI = {
  ...
  getLogs: params => api.get("/messages/logs", {
    params
  }),
  getScheduled: params => api.get("/messages/scheduled", {
    params
  }),
  cancelScheduled: id => api.delete(`/messages/scheduled/${id}`)
};
export const contactsAPI = {
  getAll: params => api.get("/contacts", {
    params
  }),
  ...
  import: fd => api.post("/contacts/import", fd, {
    headers: {
      "Content-Type": "multipart/form-data"
    }
  }),
  exportCSV: () => api.get("/contacts/export", {
    responseType: "blob"
  })
};
...
export const inventoryAPI = {
  ...
  getMovements: params => api.get("/inventory/movements", {
    params
  })
};
